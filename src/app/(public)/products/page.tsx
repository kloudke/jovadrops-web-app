...
const products = [
  { id: 1, name: "10L Water Bottle", volume: "10 Litres", price: "$2.50", category: "10L Bottles" },
  { id: 2, name: "20L Water Bottle", volume: "20 Litres", price: "$3.50", category: "20L Bottles" },
  { id: 3, name: "Dispenser Bottle", volume: "18.9 Litres", price: "$4.00", category: "Dispenser Bottles" },
  { id: 4, name: "5L Water Bottle", volume: "5 Litres", price: "$1.50", category: "5L Bottles" },
  { id: 5, name: "10L (Pack of 2)", volume: "10 Litres x 2", price: "$4.50", category: "10L Bottles" },
  { id: 6, name: "20L (Pack of 2)", volume: "20 Litres x 2", price: "$6.50", category: "20L Bottles" },
  { id: 7, name: "Dispenser Bottle", volume: "18.9 Litres", price: "$4.00", category: "Dispenser Bottles" },
  { id: 8, name: "Alkaline Water 10L", volume: "10 Litres", price: "$3.00", category: "10L Bottles" },
]
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
            {categories.map((category) => (
              <button 
                key={category}
                type="button"
                className={`cursor-pointer rounded-md px-6 py-3 font-semibold transition-all duration-200 border ${
